...
import AddForm from '@/components/dashboard/blogs/AddForm'
import Table from '@/components/dashboard/blogs/Table'
    ...
    return (
        <>
            <div className="w-screen min-h-screen px-0 md:px-12 py-4">
                <h1 className="font-bold text-3xl text-center md:text-left mt-12">
                    Blogs Page
                </h1>
                <svg
                    ...
                    viewBox="0 0 512 512"
                    className="w-10 mt-7 ms-3 md:ms-0">
